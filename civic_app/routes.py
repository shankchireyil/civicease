...
from civic_app import app, db, bcrypt
from civic_app.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
from civic_app.models import User, Post, Review, Interest, Notification
